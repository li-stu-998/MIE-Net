...
def return_ucf101(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = 'data/ucf101/rawframes/'
...
def return_diving(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DIVING_DATASET + 'rawframes'
        filename_imglist_train = '/data/lyt/mmaction2_data/diving48/diving48_train_list_rawframes.txt'
        filename_imglist_val = '/data/lyt/mmaction2_data/diving48/diving48_val_list_rawframes.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_JUMP_DATASET + 'UCF101/jpg'
        filename_imglist_train = 'UCF101/file_list/ucf101_flow_train_split_1.txt'
        filename_imglist_val = 'UCF101/file_list/ucf101_flow_val_split_1.txt'
        prefix = 'flow_{}_{:05d}.jpg'
    else:
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   'ucf101': return_ucf101, 'hmdb51': return_hmdb51,'jump': return_jump,'diving': return_diving,
    ...
    #diving
    # file_imglist_train = os.path.join(ROOT_DIVING_TRAIN_DATASET, file_imglist_train)
    # file_imglist_val = os.path.join(ROOT_DIVING_VAL_DATASET, file_imglist_val)
    # #jump 
    # file_imglist_train = os.path.join(ROOT_TRAIN_DATASET, file_imglist_train)
    # file_imglist_val = os.path.join(ROOT_VAL_DATASET, file_imglist_val)
    if isinstance(file_categories, str):
        file_categories = os.path.join(ROOT_UCF101_CLASS, file_categories)
